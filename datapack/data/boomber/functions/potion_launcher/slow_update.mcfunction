...
execute as @e[type=item, nbt={Item: {tag: {boomber: {hotbar_gui: {is_open: 1b}}, ctc: {traits: {'boomber/hotbar_gui': 1b}}}}}, tag=!global.ignore, tag=!global.ignore.kill] at @s run function boomber:potion_launcher/item/hotbar_gui/main
